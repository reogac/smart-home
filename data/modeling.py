...
NUM_FEATURES = 9        #number of features for prediction
NUM_CSV_COLS = 9        #number of columns in CVS file ('time', `power`, 'temp', 'humidity', 'light'
...
SAMPLING_SIZE = 10      #1 for 30 secs, 2 for 1 minutes, 10 for 5 minutes, 60 for 30 minutes and so on...
